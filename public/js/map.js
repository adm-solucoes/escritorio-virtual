...
(function () {
  ...
  const ROOMS = [
    ...
    { id: 'cabine3', nome: 'Cabine 3', r0: 11, c0: 3, r1: 13, c1: 7, piso: 'espinha_fria', cor: '#4d8fa0', labelR: 11, labelC: 3, privativa: true },
    { id: 'reuniao', nome: 'Sala de Reuniao', r0: 3, c0: 12, r1: 13, c1: 18, piso: 'madeira_escura', cor: '#cf4a41', labelR: 3, labelC: 11, privativa: true },
    { id: 'huddle1', nome: 'Huddle 1', r0: 3, c0: 20, r1: 7, c1: 25, piso: 'madeira_escura', cor: '#e0607e', labelR: 3, labelC: 20, privativa: true },
    { id: 'huddle2', nome: 'Huddle 2', r0: 9, c0: 20, r1: 13, c1: 25, piso: 'madeira_escura', cor: '#e0607e', labelR: 9, labelC: 20, privativa: true },
    // Silenciosa: dentro dela a chamada por proximidade nao abre (calls.js).
    { id: 'biblioteca', nome: 'Biblioteca', r0: 3, c0: 29, r1: 13, c1: 35, silenciosa: true, piso: 'madeira_escura', cor: '#3f7a5a', labelR: 7, labelC: 29 },
    { id: 'copa', nome: 'Copa e Lounge', r0: 3, c0: 36, r1: 13, c1: 44, piso: 'ladrilho', cor: '#c08a3e', labelR: 5, labelC: 37 },

    // --- sul: recepcao e os quatro bairros ---
    { id: 'recepcao', nome: 'Recepcao', r0: 18, c0: 3, r1: 29, c1: 9, piso: 'espinha', cor: '#8b98a8', labelR: 18, labelC: 3 },
    { id: 'bairro_a', nome: 'Foco A', r0: 18, c0: 11, r1: 23, c1: 26, piso: 'madeira', cor: '#7a5cd0', labelR: 18, labelC: 11 },
    { id: 'bairro_b', nome: 'Foco B', r0: 24, c0: 11, r1: 29, c1: 26, piso: 'madeira', cor: '#3f7fc4', labelR: 24, labelC: 11 },
    { id: 'bairro_c', nome: 'Projetos', r0: 18, c0: 28, r1: 23, c1: 43, piso: 'madeira_clara', cor: '#c25a3f', labelR: 18, labelC: 28 },
    { id: 'bairro_d', nome: 'Marketing', r0: 24, c0: 28, r1: 29, c1: 43, piso: 'madeira_clara', cor: '#d98324', labelR: 24, labelC: 28 },
    ...
    { id: 'hall', nome: 'Hall', r0: 3, c0: 3, r1: 29, c1: 44, piso: 'tijolo', cor: '#8b98a8', labelR: 16, labelC: 22 },
    { id: 'jardim', nome: 'Jardim', r0: 0, c0: 0, r1: 31, c1: 47, piso: 'grama', cor: '#3f9e57', labelR: 1, labelC: 1 },
  ];

  // Ilhas de piso: e assim que escritorio de verdade marca zona sem levantar
  ...
  const ZONAS_PISO = [
    { r0: 18, c0: 11, r1: 23, c1: 26, piso: 'madeira' },
    { r0: 24, c0: 11, r1: 29, c1: 26, piso: 'madeira' },
    { r0: 18, c0: 28, r1: 23, c1: 43, piso: 'madeira_clara' },
    { r0: 24, c0: 28, r1: 29, c1: 43, piso: 'madeira_clara' },
    { r0: 18, c0: 3, r1: 29, c1: 9, piso: 'espinha' },
    // Tapete do canto de leitura. Linha e coluna iniciais multiplas de 3: o
    // tapete e uma peca de 3x3 com borda, e `desenharPiso` escolhe a fatia por
    // `c % 3` - fora desse alinhamento a borda sai no meio.
    { r0: 3, c0: 33, r1: 5, c1: 35, piso: 'tapete_biblioteca' },
    ...
    { r0: 6, c0: 12, r1: 11, c1: 17, piso: 'tapete_sala' },
    // SOLEIRA E CALCADA da entrada.
    //
    // O "hall" termina na linha 29, entao a celula da porta (linha 30) e a rua
    // (31) caiam no piso padrao, que e grama - dava pra ver mato DENTRO do vao
    // da porta. Aqui a soleira e a calcada ganham o mesmo creme do eixo de
    // circulacao, que e o que predio de verdade tem na frente da porta.
    { r0: 30, c0: 4, r1: 31, c1: 8, piso: 'tijolo' },
  ];
  ...
  function buildMap() {
    ...
    // verde so no canto, pra nao competir com os grupos
    set(13, 44, PLANTA);
