...
import { LayoutDashboard, Building2, KanbanSquare, ListChecks, MessageCircle, Camera, Settings, LogOut, Menu, X, User, Workflow, CalendarDays, BarChart3, Phone, Bot } from "lucide-react";
