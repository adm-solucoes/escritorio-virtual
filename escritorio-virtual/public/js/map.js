...
(function () {
  ...
  // Ilhas de carpete por cima do tijolinho do hall. Na referencia a area de
  // trabalho nao e sala: e um retangulo de carpete solto no meio do salao, sem
  // parede e sem porta. "contorno" desenha a moldura fina que marca a area.
  const ZONAS_PISO = [
    { r0: 11, c0: 9, r1: 16, c1: 19, piso: 'carpete_roxo' },   // baia A
    { r0: 11, c0: 21, r1: 16, c1: 31, piso: 'carpete_roxo' },  // baia B
    { r0: 23, c0: 4, r1: 27, c1: 10, piso: 'carpete_azul' },   // lounge
    { r0: 3, c0: 21, r1: 8, c1: 26, piso: 'grama', contorno: '#5fb87a' },
  ];
